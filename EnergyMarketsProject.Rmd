...
nuclear_comparison <- data.frame(
  ...
  sharpe_ratio = c(
    (mean(nuclear_quarterly_df$Nuclear_Pct_Change, na.rm = TRUE) - 0.00125) / sd(nuclear_quarterly_df$Nuclear_Pct_Change, na.rm = TRUE),
    (mean(etf_pct_long %>% filter(ETF == "NLR") %>% pull(Pct_Change), na.rm = TRUE) - 0.00125) / sd(etf_pct_long %>% filter(ETF == "NLR") %>% pull(Pct_Change), na.rm = TRUE)
  ),
  total_return = c(
...
renewables_comparison <- data.frame(
  ...
  sharpe_ratio = c(
    (mean(renewables_quarterly_df$Renewables_Pct_Change, na.rm = TRUE) - 0.00125) / sd(renewables_quarterly_df$Renewables_Pct_Change, na.rm = TRUE),
    (mean(etf_pct_long %>% filter(ETF == "TAN") %>% pull(Pct_Change), na.rm = TRUE) - 0.00125) / sd(etf_pct_long %>% filter(ETF == "TAN") %>% pull(Pct_Change), na.rm = TRUE)
    ),
  total_return = c(
...
fossil_fuel_comparison <- data.frame(
  ...
  sharpe_ratio = c(
    (mean(fossil_fuel_quarterly_df$Fossil_Pct_Change, na.rm = TRUE) - 0.00125) / sd(fossil_fuel_quarterly_df$Fossil_Pct_Change, na.rm = TRUE),
    (mean(etf_pct_long %>% filter(ETF == "XLE") %>% pull(Pct_Change), na.rm = TRUE) - 0.00125) / sd(etf_pct_long %>% filter(ETF == "XLE") %>% pull(Pct_Change), na.rm = TRUE)
    ),
  total_return = c(
